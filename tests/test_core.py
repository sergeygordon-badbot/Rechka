...
from voice_input.engine import choose_chunk_length, normalize_transcript
...
class TextTests(unittest.TestCase):
    ...
    def test_chunk_length_has_safe_bounds(self) -> None:
        self.assertEqual(choose_chunk_length(2 * 16_000), 10)
        self.assertEqual(choose_chunk_length(10.4 * 16_000), 12)
    ...
    def test_legacy_medium_config_migrates_to_fast_small(self) -> None:
        ...
        try:
            with tempfile.TemporaryDirectory() as directory:
                ...
                actual = load_config()
                self.assertEqual(actual.model, "small")
